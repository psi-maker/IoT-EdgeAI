...
![Asynchronous API](asynchronous.gif)  
# THEORY
...
*	If there is a new object, add it to the tracking system.
*	If the tracker lost the object, add it again.
*	If tracking the new ROI has been moved away enough from the original object, reset the tracker for that object.
*	If a detected object is about to exit the scene, remove it.
* If there is a lost object being tracked, remove it.  
...
## implemented Boost’s log module to register events on a unique file
## Dashboard
...
* Improve the algorithm of matrix calculation for the reflection from 3-dimension to 2-dimension 
